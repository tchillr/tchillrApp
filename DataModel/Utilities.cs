...
namespace TchillrREST
{
    ...
    {
        private static TchillrREST.DataModel.TchillrDataBaseEntities context = null;

        public static TchillrREST.DataModel.TchillrDataBaseEntities TchillrContext
        {
            get
            {
                if( context == null){
                    context = new TchillrREST.DataModel.TchillrDataBaseEntities(ConfigurationManager.ConnectionStrings["TchillrDataBaseEntities"].ConnectionString);
